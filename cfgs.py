...
# ---------------------------------------- System_config
ROOT_PATH = os.path.abspath('/home/anil/FPN_Tensorflow')
print (20*"++--")
print (ROOT_PATH)
GPU_GROUP = "0"
...
DATASET_NAME = 'damage'  # 'ship', 'spacenet', 'pascal', 'coco'
PIXEL_MEAN = [123.68, 116.779, 103.939]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
IMG_SHORT_SIDE_LEN = 513  # 600  # 600
IMG_MAX_LENGTH = 513  # 1000  # 1000
CLASS_NUM = 2
